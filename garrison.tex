...
%Although I have not worked on assembly algorithms directly,
I have supported genome assembly pipelines like that used by the Vertebrate Genomes Project, where I helped to apply haplotype-based variant detection methods for assembly polishing.
...
\\
\\
This R01 proposal revolves around the expansion of computational methodologies for the analysis of CRISPR genome editing outcomes, harnessing my proficiency in pangenome analysis and long-read sequencing.
In ongoing, unpublished work (FANTASTIC-LAMP), we are utilizing variation graphs to assess editing outcomes from genome sequencing data generated by Inscripta, thereby affirming our competence in graph-based quantification of such events.
\\
\\
The project incorporates two primary aims; Aim 1 pertains to the enhancement of the CRISPRme off-target prediction tool, incorporating pangenomes and variation graphs to enable an in-depth risk assessment across genetically diverse populations.
Our expertise in pangenome graph models is instrumental in this phase.
Aim 2 centers on steering the analysis of long-read sequencing data from technologies such as Nanopore and PacBio.
This will assist in the development of the CRISPRessoXL tool to quantify intricate editing outcomes, capitalizing on my assembly skills to establish a comprehensive benchmark genome assembly for one donor.
The aim is to leverage our combined expertise in pangenome analysis, variation graph quantification, and long-read sequencing to facilitate improvements in CRISPR genome editing data analysis tools, thereby promoting safer and more effective use of CRISPR technologies.
...
\item Wen-Wei Liao, Mobin Asri, Jana Ebler, Daniel Doerr et al. \emph{A Draft Human Pangenome Reference}. \hijournal{Nature} 617, 312–324, DOI:10.1038/s41586-023-05896-x 2023.

\item Andrea Guarracino, Silvia Buonaiuto, Leonardo Gomes de Lima et al. \emph{Recombination between heterologous human acrocentric chromosomes}. \hijournal{Nature} 617, 335–343 DOI:10.1038/s41586-023-05976-y 2023.
...
2005--2006 & Research assistant, Harvard Kennedy School of Government, Cambridge, MA, USA \\
\end{datetbl}
